...
import 'package:flareline/monitoring/drivermonitoring.dart';
  ...
  Widget contentDesktopWidget(BuildContext context) {
    return Row(
      children: [
        InkWell(
          onTap: () {
            Get.to(DriverControl());
          },
          child: Expanded(
              child: _itemCardWidget(
                  context, Icons.car_rental, '', 'Drivers', '0.43%', true)),
        ),
        const SizedBox(
          width: 16,
        ),
        ...
        Expanded(
            child: _itemCardWidget(
                context, Icons.group, '2.450', 'Passengers', '0.43%', true)),
        const SizedBox(
          width: 16,
        ),
        Expanded(
